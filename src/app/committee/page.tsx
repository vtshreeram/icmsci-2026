  ...
  return (
    <div className="min-h-screen">
      ...
      <section
        ...
        style={{
          backgroundImage:
            "linear-gradient(rgba(15, 23, 42, 0.78), rgba(30, 64, 175, 0.82)), url('https://images.unsplash.com/photo-1521737604893-d14cc237f11d?w=1920&q=80&auto=format&fit=crop')",
