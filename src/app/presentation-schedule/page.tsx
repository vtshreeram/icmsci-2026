  ...
  return (
    <div className="min-h-screen">
      ...
      <section
        ...
        style={{
          backgroundImage:
            "linear-gradient(rgba(15, 23, 42, 0.80), rgba(30, 64, 175, 0.84)), url('https://images.unsplash.com/photo-1506784983877-45594efa4cbe?w=1920&q=80&auto=format&fit=crop')",
