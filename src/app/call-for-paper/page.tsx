  ...
  return (
    <div className="min-h-screen">
      ...
      <section
        ...
        style={{
          backgroundImage:
            "linear-gradient(rgba(15, 23, 42, 0.80), rgba(30, 64, 175, 0.84)), url('https://images.unsplash.com/photo-1455390582262-044cdead277a?w=1920&q=80&auto=format&fit=crop')",
